...
public class RelatorioVaraController extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws SQLException, ClassNotFoundException, JRException {
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment;filename=relatorioVara.pdf");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RelatorioVaraController.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(RelatorioVaraController.class.getName()).log(Level.SEVERE, null, ex);
        } catch (JRException ex) {
            Logger.getLogger(RelatorioVaraController.class.getName()).log(Level.SEVERE, null, ex);
