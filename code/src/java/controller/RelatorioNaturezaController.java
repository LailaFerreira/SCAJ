...
public class RelatorioNaturezaController extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws SQLException, ClassNotFoundException, JRException {
        ...
        try {
            ...
            response.setHeader("Content-Disposition", "attachment;filename=relatorioNatureza.pdf");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RelatorioNaturezaController.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(RelatorioNaturezaController.class.getName()).log(Level.SEVERE, null, ex);
        } catch (JRException ex) {
            Logger.getLogger(RelatorioNaturezaController.class.getName()).log(Level.SEVERE, null, ex);
