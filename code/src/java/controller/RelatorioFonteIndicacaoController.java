...
public class RelatorioFonteIndicacaoController extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws SQLException, ClassNotFoundException, JRException {
        ...
        try {
            ...
            String nomeRelatorio = "fonteIndicacao";
            ...
            response.setHeader("Content-Disposition", "attachment;filename=relatorioIndicacao.pdf");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RelatorioFonteIndicacaoController.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(RelatorioFonteIndicacaoController.class.getName()).log(Level.SEVERE, null, ex);
        } catch (JRException ex) {
            Logger.getLogger(RelatorioFonteIndicacaoController.class.getName()).log(Level.SEVERE, null, ex);
