...
public class RelatorioInstanciaController extends HttpServlet {
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws SQLException, ClassNotFoundException, JRException {
        ...
        try {
            ...
            String nomeRelatorio = "instancia";
            ...
            response.setHeader("Content-Disposition", "attachment;filename=relatorioInstancias.pdf");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(RelatorioInstanciaController.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(RelatorioInstanciaController.class.getName()).log(Level.SEVERE, null, ex);
        } catch (JRException ex) {
            Logger.getLogger(RelatorioInstanciaController.class.getName()).log(Level.SEVERE, null, ex);
